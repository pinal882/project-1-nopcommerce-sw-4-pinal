...
public class CheckoutPage extends Utility {
    ...
    By radiobutton = By.xpath("//input[@id='shippingoption_2']");
    By continuetab = By.xpath("//button[@class='button-1 shipping-method-next-step-button']");
    By radiobuttoncreditcard = By.xpath("//label[normalize-space()='Credit Card']");
    By dropdown = By.xpath("//select[@id='CreditCardType']");
    ...
    //public String selectVisaCardFromDropDown(){
     //  return selectByValueFromDropDown(dropdown);
    }
